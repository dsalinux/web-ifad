...
public class QuestionarioConverter implements Converter {
    ...
    public Object getAsObject(FacesContext facesContext, UIComponent uiComponent, String value) {
        if (value != null && !value.isEmpty()) {
            return (Questionario) uiComponent.getAttributes().get(value);
        }
        return null;
    }
    ...
    public String getAsString(FacesContext facesContext, UIComponent uiComponent, Object value) {
        if (value instanceof Questionario) {
            Questionario entity= (Questionario) value;
            if (entity != null && entity instanceof Questionario && entity.getId() != null) {
